...
| `larencontre-avis-220.mjs` | **corrige le nombre d'avis dans les annonces** : « 5,0/5 sur 150 avis Google » → « 5,0/5, Plus de 220 Avis Google » dans un titre et une description par groupe (annonces mises à jour en place, même id, pins conservés), et accroche de campagne remplacée (nouvelle créée et liée, ancienne déliée — un composant ne s'édite pas). Reprenable, valide avant d'écrire, relit après. **Appliqué le 11/09/2026 : 7 textes, annonces restées `APPROVED`** | 11/09/2026 |
| `larencontre-exclusions.mjs` | **pose les exclusions du relevé J+1** en correspondance d'expression, lues dans `../data/exclusions-proposees-2026-09-04.json`. Dédoublonne contre l'existant sans dépouiller les accents — c'est le point de la manœuvre — valide chez Google avant d'écrire, et relit après coup. **Appliqué le 04/09/2026 : 27 → 147 exclusions.** Accepte `--source <json>` pour une vague ultérieure : **deuxième vague appliquée le 11/09/2026 : 147 → 529** depuis `../data/exclusions-proposees-2026-09-10.json` | 11/09/2026 |
...
| Exclusions | **529 au niveau campagne** (27 au montage, 120 posées le 04/09, 382 posées le 11/09 — `../data/exclusions-proposees-2026-09-10.json`), 502 en expression et 27 en large |
| Composants | liens annexes, accroches, extrait, appel (01/09) · **6 images** carré et paysage — plats, devanture, chefs (07/09) · accroche avis passée à « 5,0/5, plus de 220 avis » (11/09) |
| État | **ACTIVE depuis le 03/09/2026** — annonces revenues `APPROVED` (force « Bonne ») et 6 images `ELIGIBLE` au relevé J+7 du 10/09 ; **première conversion le 09/09** · textes d'avis corrigés à « plus de 220 » le 11/09, toujours `APPROVED` |
